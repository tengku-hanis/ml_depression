...
tictoc::toc() # 7419.167 sec elapsed
beepr::beep(3)

# Save CV result
# readr::write_rds(logreg_tuned, "full_data_analysis_7Dec2025/cv_results/30features/logreg_cv_result.rds")
...
# Plot
autoplot(logreg_tuned)
autoplot(logreg_tuned, metric = "sens")
autoplot(logreg_tuned, metric = "spec")
autoplot(logreg_tuned, metric = "pr_auc")
autoplot(logreg_tuned, metric = "f_meas_two")
...
# Save final model
# readr::write_rds(logreg_final_model, "full_data_analysis_7Dec2025/final_models/30features/logreg_mod.rds")
